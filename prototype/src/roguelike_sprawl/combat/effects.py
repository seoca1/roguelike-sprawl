...
# ----------------------------------------------------------------------------
# Re-exports for backward compat (ADR-0112 module split)
# ----------------------------------------------------------------------------

from .effects_vfx import (  # noqa: E402,F401
    # Class (moved to effects_vfx for module split)
    CombatEffects,
...
__all__ = [
    # Data classes (re-exported for explicit access)
    "IceType",
    "StatusIcon",
    "AnimationFrame",
    "Animation",
    ...
    "ComboCounter",
    "CombatEffects",
    # Behavior (re-exported from effects_vfx for backward compat)
    "attack_animation",
    "buff_animation",
    "counter_animation",
    "debuff_animation",
