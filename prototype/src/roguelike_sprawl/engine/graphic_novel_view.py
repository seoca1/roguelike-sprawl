...
Module structure (post ADR-0111 split 2026-07-27):
    ...
    - graphic_novel_view (this file): render + menu + screen

Re-exports: dataclasses and loaders remain importable from this module
for backward compatibility (ADR-0111).
"""
